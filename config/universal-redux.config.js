...
const isStaging = process.env.TARGET === 'staging';
...
module.exports = {
  ...
  server: {
    ...
    */
    ...
    //
    // Expects: (investigate on Express middleware site)
    */
    maxAge: '1y'
  },
  ...
  */
  ...
  globals: {
    ...
    /*
     ...
     // Expects: Boolean
     */
    __LOGGER__: !(isProduction || isStaging),
    ...
    /*
     ...
     // Expects: Boolean
     */
    __DEVTOOLS__: !(isProduction || isStaging),
    ...
    */
    ...
    __FIREBASE_URL__: 'https://deezer-test.firebaseio.com',
  },
  ...
  lint: {
    enabled: false,
    config: projectRoot + '/config/.eslintrc'
  },

  babelConfig: projectRoot + '/config/.babelrc',
  ...
  redux: {
    /*
     ...
     // Expects: String
     */
    reducers: sourceRoot + '/redux/handlers/index.js',
  ...
  html: {
    ...
    // Expects: String
    */
    head: sourceRoot + '/containers/Head.js',
